	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<form id="form-profile"
				action="/TraineeManager/admin/danh-sach-lop?action=edit_class"
				method="POST">
...
<div class="modal fade" id="DeleteUserModalCenter" tabindex="-1"
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<!--  -->
			<form id="delete-form"
				action="/TraineeManager/admin/danh-sach-lop?action=delete_class"
				method="POST">
	...
	$('.course-filter')
			.change(
					function() {
						...
						//alert(id);
						var path = "/TraineeManager/admin/danh-sach-lop?action=danhsachlop&course="
								+ id;
